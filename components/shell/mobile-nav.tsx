...
export function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      {open && (
        <div className="fixed inset-x-0 top-14 bottom-0 z-50 overflow-y-auto bg-background/98 p-6 backdrop-blur-xl border-b border-border">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span>Organization Settings & Entitlements</span>
                  </div>
                  <ArrowRight className="size-3.5 text-muted-foreground" />
                </Link>
                <Link
                  ...
                  className="flex items-center justify-between rounded-lg border border-border bg-card p-3 font-mono text-xs text-foreground transition hover:border-primary/50"
                >
                  <span>Deterministic Demo Environments</span>
                  <ArrowRight className="size-3.5 text-muted-foreground" />
                </Link>
              </div>
            </div>
