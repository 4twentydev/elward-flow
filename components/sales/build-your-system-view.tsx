...
export function BuildYourSystemView() {
  ...
  const [targetTimeline, setTargetTimeline] = React.useState<"immediate_pilot" | "quarterly_rollout" | "exploratory">("immediate_pilot");
  const [primaryBottleneck, setPrimaryBottleneck] = React.useState("Drawing revision mismatches and paper traveler lost time.");
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    <button
                      key={sz.id}
                      onClick={() => setShopSize(sz.id as any)}
