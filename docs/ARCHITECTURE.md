...
`rivetworks/website` and `rivetworks/operations` deploy independently. Public pages link to safe demo entry points or approved screenshots. No shared database or implicit session.
